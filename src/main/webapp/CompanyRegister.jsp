...
<div class="card">
    ...
    <div class="card-body px-lg-5 pt-0">
        ...
        <form class="md-form" action="Company" method="post" style="color: #757575;">
					...
					<input type="text" name="com_id" id="materialRegisterFormid" class="form-control">
                    <label for="materialRegisterFormFirstName">ID</label>
						
					
                    <input type="text" name="com_Name" id="materialRegisterFormFirstName" class="form-control">
                    ...
                    <label for="materialRegisterFormEmail">E-mail</label>
                     ...
                     <input type="text" name="Address" id="materialRegisterFormLastName" class="form-control">
